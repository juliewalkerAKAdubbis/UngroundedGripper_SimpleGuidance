...
#define INT_CLMP       1      // maximum allowed integrated error
#define PI  3.14159
#define MAX_STRETCH 5.0			// maximum radius of stretch from centerpoint
...
public:
	...
	double len[5] = { 10.0, 13.0, 13.0, 10.0, 10.0 };		
	double center[2] = { chai3d::cDegToRad(60), chai3d::cDegToRad(120) };
